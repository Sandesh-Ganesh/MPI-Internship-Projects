...
export const SSLCertificateForm = ({initialValues, onSubmit}: any) => {
    ...
    <div className="card p-5">
      ...
      <div className="row mb-5">
        <div className="col-md-4">
          ...
          <select name="cert_type" value={form.cert_type} className="form-select" onChange={handleChange}>
        ...
        <div className="col-md-4">
          ...
          <select name="validation_type" value={form.validation_type} className="form-select" onChange={handleChange}>
        ...
        <div className="col-md-4">
          ...
          <select name="encryption_type" value={form.encryption_type} className="form-select" onChange={handleChange}>
      ...
      <div className="row mb-5">
        <div className="col-md-6">
          ...
          <select name="vendor_id" value={form.vendor_id} className="form-select" onChange={handleChange}>
        ...
        <div className="col-md-6">
          ...
          <select name="control_panel_id" value={form.control_panel_id} className="form-select" onChange={handleChange}>
