...
import { createCostCenter, getAllCostCenters, getCostCenterById, updateCostCenter, deleteCostCenter,
getCostCentersByCompanyId
...
router.get("/company/:companyId", getCostCentersByCompanyId) // New route for fetching cost centers by company ID
